# TASK-005: Unit testing: advanced filter query logic

## Task ID
TASK-005

## Task Title
Unit testing: advanced filter query logic
...
## Task Description
Test each advanced filter parameter individually and in combination with basic filters.
...
## Expected Output
A working, tested implementation of: **Unit testing: advanced filter query logic**, satisfying the relevant Acceptance Criteria of [US-002 &mdash; Apply Advanced Filters on the Filters Page](../../US.md), ready for code review and merge.
