# TASK-003: Frontend: Build Duplicates page with JD groups

## Task ID
TASK-003

## Task Title
Frontend: Build Duplicates page with JD groups
...
## Task Description
Build JD group headers, summary counters, comparison cards, and empty-state notes matching the existing UI.
...
## Expected Output
A working, tested implementation of: **Frontend: Build Duplicates page with JD groups**, satisfying the relevant Acceptance Criteria of [US-002 &mdash; View Duplicates Grouped by Job Description](../../US.md), ready for code review and merge.

---
*Task 3 of 5 for US-002 | Category: Frontend / UI*
