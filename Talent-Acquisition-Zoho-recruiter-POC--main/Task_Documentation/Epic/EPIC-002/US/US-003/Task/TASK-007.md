# TASK-007: Unit testing: normalization logic

## Task ID
TASK-007

## Task Title
Unit testing: normalization logic
...
## Task Description
Write unit tests covering each normalization mapping category and the unmapped-value passthrough case.
...
## Expected Output
A working, tested implementation of: **Unit testing: normalization logic**, satisfying the relevant Acceptance Criteria of [US-003 &mdash; Normalize & Persist Synced Candidate Data](../../US.md), ready for code review and merge.
