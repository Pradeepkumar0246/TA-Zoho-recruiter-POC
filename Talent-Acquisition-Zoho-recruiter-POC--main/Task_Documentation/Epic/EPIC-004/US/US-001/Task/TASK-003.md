# TASK-003: Frontend: Build inline Filter Panel component

## Task ID
TASK-003

## Task Title
Frontend: Build inline Filter Panel component
...
## Task Description
Build the collapsible Basic Filters panel with show/hide toggle on the Candidates page.
...
## Expected Output
A working, tested implementation of: **Frontend: Build inline Filter Panel component**, satisfying the relevant Acceptance Criteria of [US-001 &mdash; Toggle & Apply Basic Filters on the Candidates Page](../../US.md), ready for code review and merge.

---
*Task 3 of 7 for US-001 | Category: Frontend / UI*
