# TASK-005: Frontend: Build Requirement Profile card

## Task ID
TASK-005

## Task Title
Frontend: Build Requirement Profile card
...
## Task Description
Build the weighted bar-row display (and edit mode, if in scope) for a JD's ranking criteria on the Ranking page.
...
## Expected Output
A working, tested implementation of: **Frontend: Build Requirement Profile card**, satisfying the relevant Acceptance Criteria of [US-001 &mdash; Define Weighted Requirement Profile for a JD](../../US.md), ready for code review and merge.

---
*Task 5 of 6 for US-001 | Category: Frontend / UI*
